    ...
    return (
        <div className="flex flex-col items-center lg:flex-row px-4 lg:w-full max-w-8xl gap-6 lg:gap-16">
            <div className=''>
                ...
                <p className='pb-2 text-sm max-w-lg m-auto xl:p-0 xl:text-base xl:max-w-xl xl:pb-3 3xl:text-xl 3xl:max-w-2xl 3xl:pb-5'>
                ...
                <p className='pb-4 text-sm max-w-lg m-auto xl:p-0 xl:text-base xl:max-w-xl xl:pb-6 3xl:text-xl 3xl:max-w-2xl 3xl:pb-8'>
                ...
                <a href={cv} target="_blank" className='flex overflow-visible gap-2 px-5 py-2  bg-caribbean-current dark:bg-caribbean-current-dark w-fit text-white rounded mb-6 3xl:mb-8 group/Resume hover:text-orange-peel dark:hover:text-orange-peel-dark'>
                ...
                <div className='flex justify-evenly bg-caribbean-current dark:bg-caribbean-current-dark text-white py-3 mb-6 3xl:mb-8'>
