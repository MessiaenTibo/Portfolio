...
const TypeAnimation = ({ title, typeAnimation, classAtribute, animationDelay = 120 }: { title: string; typeAnimation?: boolean, classAtribute?: string, animationDelay?: number }) => {
  ...
  return (
    <h1 data-testid="cypress-title" className={` ${classAtribute} text-2xl text-caribbean-current dark:text-caribbean-current-dark pt-6 pb-5 font-bold xl:text-3xl xl:pt-8 xl:pb-10 2xl:text-4xl 2xl:pt-10 2xl:pb-12 `}>
      {text}
    </h1>
  );
};
