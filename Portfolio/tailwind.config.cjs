  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fade-in-from-left-1': 'fade-in-from-left 0.25s ease-out',
        'fade-in-from-left-2': 'fade-in-from-left 0.5s ease-out',
        'fade-in-from-left-3': 'fade-in-from-left 0.75s ease-out',
        'fade-in-from-left-4': 'fade-in-from-left 1s ease-out',
